function [bandwidth,density,X,Y,t_star,t_x,t_y]=kde2d(data,n,MIN_XY,MAX_XY,varargin)
...
%
% Note (Chris Cotter):
% from https://www.mathworks.com/matlabcentral/fileexchange/36153-2d-bandwidth-estimator-for-kde
%
