function [Mdlb, Mdlr, Mdlst, Init] = create_search_trees(AllDataTable)
    ...
    T = AllDataTable;
    T = T(~isnan(T.theta1),:); %Remvoes a few runs that move no distance, leaving theta, phi, and beta undefined
    ...
    Mdlr(1).KNN = KNNSampler([Ti.chi Ti.TSS1 Ti.Dn1 Ti.phi0]);
    ...
    Mdlr(2).KNN = KNNSampler([Ti.chi Ti.TSS1 Ti.Dn1 Ti.phi0]);
    ...
    Mdlr(3).KNN = KNNSampler([Ti.chi Ti.TSS1 Ti.Dn1 Ti.phi0]);
