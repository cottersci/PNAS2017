...
#
# where data_loc is the path to AllDataTable.mat and
...
matlab -nojvm -nodisplay -nosplash \
     -r "addpath('Models/ClosedLoopModel/SimulationCreation/'); BatchRunSimulations('Results/$PBS_JOBNAME/','${data_loc}')"  \
     > matlab_${PBS_JOBNAME}.out
