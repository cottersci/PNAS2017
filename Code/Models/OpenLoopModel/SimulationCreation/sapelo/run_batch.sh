...
cp -r Models/OpenLoopModel $RESULTS_FOLDER/Models/
cp -r Models/ModelBase $RESULTS_FOLDER/Models/
cp -r Libraries/Utils $RESULTS_FOLDER/Libraries/

cd $RESULTS_FOLDER
qsub -v data_loc=$DATA_FOLDER -N $JOB_NAME Models/OpenLoopModel/SimulationCreation/sapelo/submission_script.sh